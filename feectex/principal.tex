...
\titulo{CapsNet ainda vale a pena?}

% Quais são as palavras-chave, em português e em inglês,
% relacionadas ao trabalho?
\palavraschave{Redes de cápsulas, Equivariância, Robustez, Aumento de dados, Detecção de incêndio}
\keywords{Capsule networks, Equivariance, Robustness, Data augmentation, Fire detection}
