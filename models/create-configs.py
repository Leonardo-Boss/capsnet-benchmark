...
config = read_yaml('config-dfire.yaml')
ecaps = read_yaml('config-ecaps-dfire.yaml')
deit = read_yaml('config-deit-dfire.yaml')
resnet = read_yaml('config-resnet-dfire.yaml')
...
databases = (
        ...
        {'name':'dfire', 'type':'DFireDataLoader'},
)
augmentations = (
    'none',
    'standard',
